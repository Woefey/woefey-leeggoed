...
RegisterNetEvent('woefey-leeggoed:server:sellleeggoed', function()
    ...
    if xItem ~= nil then
        ...
        Player.Functions.AddMoney("cash", price, "sold-resources")
            ...
            TriggerEvent("qb-log:server:CreateLog", "sellleeggoed", "resources", "blue", "**"..GetPlayerName(src) .. "** heeft €"..price.." Gekregen vor je leeggoed.")
                end
            end
        end
    else
        TriggerClientEvent('QBCore:Notify', src, "Je hebt geen leeggoed!")
    end
